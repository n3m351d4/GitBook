...
![Рис. 1. Структурная схема приёмника и передатчика трансивера.](<../../.gitbook/assets/image (105).png>)
...
![Рис. 2. Архитектура с ФАПЧ.](<../../.gitbook/assets/image (106).png>)
...
![Рис. 3. Типовая архитектура приёмника.](<../../.gitbook/assets/image (88).png>)
...
![Рис. 4. Типовой супергетеродинный приёмник.](<../../.gitbook/assets/image (84).png>)
...
![Рис. 5. Типовой приёмник с низкой ПЧ.](<../../.gitbook/assets/image (81).png>)
...
![Рис. 6. Архитектура типового гомодинного приёмника прямого преобразования.](<../../.gitbook/assets/image (101).png>)
...
![Рис. 7. Типовая архитектура приёмника с субдискретизацией](<../../.gitbook/assets/image (79).png>)
...
![Рис. 8. Уравнение дальности выражает зависимость принимаемой мощности от расстояния.](<../../.gitbook/assets/image (96).png>)
...
![Рис. 9. Типовой канал связи.](<../../.gitbook/assets/image (99).png>)
...
![Рис. 10. Работа смесителя в типовом гетеродинном приёмнике.](<../../.gitbook/assets/image (85).png>)
...
![Рис. 11. Фазовый шум. ](<../../.gitbook/assets/image (104).png>)
...
![Рис. 12. Схема нелинейной системы.](<../../.gitbook/assets/image (93).png>)
...
![Рис. 13. Интермодуляционные составляющие.](<../../.gitbook/assets/image (77).png>)
...
![Рис. 14. Коэффициент шума для нескольких последовательных каскадов в ВЧ тракте.](<../../.gitbook/assets/image (92).png>)
...
![Рис. 15. Верхний и нижний соседние каналы.](<../../.gitbook/assets/image (80).png>)
...
![Рис. 16.](<../../.gitbook/assets/image (97).png>)
...
![Рис. 17. Точка пересечения по интермодуляционным составляющим третьего порядка.](<../../.gitbook/assets/image (103).png>)
...
![Рис. 18. Отношение сигнала к шуму.](<../../.gitbook/assets/image (107).png>)
...
![Рис. 19. Распределение восходящих и нисходящих каналов и полосы разделения.](<../../.gitbook/assets/image (102).png>)
